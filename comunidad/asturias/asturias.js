document.addEventListener('DOMContentLoaded', () => {
    ...
    const dictionary = {
        'fuentes-del-narcea': 'Fuentes del Narcea',
        'oriente-de-asturias': 'Oriente de Asturias',
        'la-sidra': 'Comarca de la Sidra',
        'valle-del-nalon': 'Valle del Nalón',
        'montaña-central': 'Montaña Central',
        'camin-real-de-la-mesa': 'Camín Real de la Mesa',
        'comarca-central': 'Comarca Central', // O "Área Central"
        'eonavia': 'Eo-Navia',
        'cabo-peñas': 'Cabo Peñas',
        'aviles': 'Comarca de Avilés',
        'el-bajo-nalon': 'Bajo Nalón',
        'vaqueira': 'Comarca Vaqueira'
    };
