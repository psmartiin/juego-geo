document.addEventListener('DOMContentLoaded', () => {
    ...
    const dictionary = {
        // CORRECCIONES DE IDS RAROS O ERRATAS DEL SVG
        'o-sar_1_': 'O Sar',
        'mora': 'Muros',                // Corregido error del SVG
        'a-fondagrada': 'A Fonsagrada', // Corregido error del SVG
        'eonavia': 'Ortegal',           // En este mapa concreto, esta zona suele ser Ortegal
        'ferrolterra': 'Ferrol',

        // NOMBRES CON TILDES Y ARTÍCULOS
        'a-coruña': 'A Coruña',
        ...
        // LUGO
        'a-mariña-occidental': 'A Mariña Occidental',
        'a-mariña-central': 'A Mariña Central',
        'a-mariña-oriental': 'A Mariña Oriental',
        'a-terra-cha': 'Terra Chá',
        'meira': 'Meira',
        'lugo': 'Lugo',
        'os-ancares': 'Os Ancares',
        'sarria': 'Sarria',
        'a-terra-de-lemos': 'Terra de Lemos',
        'chantada': 'Chantada',
        'a-ulloa': 'A Ulloa',
        'quiroga': 'Quiroga',
        ...
        'o-ribeiro': 'O Ribeiro',
        'ourense': 'Ourense',
        'a-terra-de-celanova': 'Terra de Celanova',
        'a-limia': 'A Limia',
        'baixa-limia': 'Baixa Limia',
        'verin': 'Verín',
        'viana': 'Viana',
        'valdeorras': 'Valdeorras',
        'terra-de-trives': 'Terra de Trives',
        'a-terra-de-caldelas': 'Terra de Caldelas',
        'allariz-maceda': 'Allariz-Maceda',

        // PONTEVEDRA
        'deza': 'Deza',
        'tabeiros-a-terra-de-montes': 'Tabeirós-Terra de Montes',
        'caldas': 'Caldas',
        'o-salnes': 'O Salnés',
        ...
        'vigo': 'Vigo',
        'o-condado': 'O Condado',
        'a-paradanta': 'A Paradanta',
        'o-baixo-minho': 'O Baixo Miño'
